...
export default function ApprovalsPage() {
  ...
  if (isLoading) return <LoadingState message="Memuat approvals..." />;
    ...
    return (
      <div className="space-y-4">
        <div className="flex justify-between items-center">
          ...
          <ActionButton icon={<CheckCircle2 className="h-4 w-4" />}>Create Approval</ActionButton>
        </div>
        <EmptyState icon={<CheckCircle2 className="h-12 w-12" />} title="Tidak ada approval pending" description="Semua request sudah diproses." />
      </div>
    );
  }
